...
<img src="https://github.com/fangsong0517/Figure-bed/blob/master/2020-02-11%2014-20-02%E5%B1%8F%E5%B9%95%E6%88%AA%E5%9B%BE.png?raw=true" alt="2020-02-11 14-20-02屏幕截图.png" style="zoom:50%;" />

## 1.顺序表

![2020-02-11 14-22-22屏幕截图.png](https://github.com/fangsong0517/Figure-bed/blob/master/2020-02-11%2014-22-22%E5%B1%8F%E5%B9%95%E6%88%AA%E5%9B%BE.png?raw=true)
...
![](/home/fangsong/文档/图片/2020-02-11 18-17-34屏幕截图.png) 

##### 程序内部，内存内部

指向head的指针，体现在内存内部，内存内部节点信息，内存内部（数据域，指针域）

![](/home/fangsong/文档/图片/2020-02-11 18-38-21屏幕截图.png)
...
![](/home/fangsong/文档/图片/2020-02-11 20-35-45屏幕截图.png)
...
<img src="./图片/2020-02-11 18-42-49屏幕截图.png" style="zoom: 67%;" />
...
<img src="./图片/2020-02-13 16-10-53屏幕截图.png" style="zoom: 67%;" />

<img src="./图片/2020-02-13 16-14-47屏幕截图.png" style="zoom: 67%;" />

<img src="./图片/2020-02-13 16-15-46屏幕截图.png" style="zoom:67%;" />

队列假溢出：

<img src="/home/fangsong/文档/图片/2020-02-13 16-18-54屏幕截图.png" style="zoom:67%;" />

1,2,3空间扔在，而当前插入不下，即为假溢出，有空间能插入；

如果队尾能指向第一个元素，则引入循环队列     －>

<img src="./图片/2020-02-13 16-22-23屏幕截图.png" style="zoom:67%;" />

<img src="./图片/循环队列.png/" style="zoom:67%;" />

主要思考　头２　尾３　元素个数４

####  **（２）栈　**：后进先出

<img src="./图片/2020-02-13 16-35-54屏幕截图.png" style="zoom:50%;" />

<img src="./图片/入栈.png" style="zoom:67%;" />
...
![](/home/fangsong/文档/图片/2020-02-13 20-55-36屏幕截图.png)
...
<img src="/home/fangsong/文档/图片/2020-02-15 15-35-04屏幕截图.png" style="zoom: 67%;" />
...
![](/home/fangsong/文档/图片/2020-02-15 20-29-43屏幕截图.png)
...
<img src="/home/fangsong/文档/图片/2020-02-18 15-40-26屏幕截图.png" style="zoom:50%;" />
...
<img src="/home/fangsong/文档/图片/2020-02-18 15-52-15屏幕截图.png" style="zoom:50%;" />调整的时候不断向上调整直至满足大顶堆。
...
<img src="/home/fangsong/文档/图片/2020-02-18 16-14-30屏幕截图.png" style="zoom:50%;" />
...
![](/home/fangsong/文档/图片/2020-02-18 16-15-39屏幕截图.png)



<img src="/home/fangsong/文档/图片/2020-02-18 18-37-49屏幕截图.png" style="zoom: 80%;" />
<img src="/home/fangsong/文档/图片/2020-02-18 18-48-13屏幕截图.png" style="zoom: 80%;" />
...
归并排序一共需要进行 `O(logn) `层归并操作，每层归并操作的总时间复杂度为 `O(n)`，因此总体的时间复杂度为<font color = red>` O(nlogn)`</font>。和其他排序有所不同，为了实现归并操作，每次合并都需要开辟额外的空间来临时保存合并后的排序结果，总共需要开辟 `n`个元素的空间，所以归并排序的空间复杂度为`O(n)`<img src="/home/fangsong/文档/图片/2020-02-20 15-40-21屏幕截图.png" style="zoom: 67%;" />(*分治思想*)
...
##### 二分查找
<img src="/home/fangsong/文档/图片/2020-02-20 19-53-09屏幕截图.png" alt="二分查找" style="zoom:67%;" />
...
![](/home/fangsong/文档/图片/2020-02-20 20-05-34屏幕截图.png)
...
<img src="/home/fangsong/文档/图片/2020-02-20 20-16-00屏幕截图.png" style="zoom:67%;" />
...
#####　三分查找
![](/home/fangsong/文档/图片/2020-02-20 20-08-57屏幕截图.png)
...
![](/home/fangsong/文档/图片/2020-02-20 23-52-52屏幕截图.png)
...
<img src="/home/fangsong/文档/图片/2020-02-22 14-33-34屏幕截图.png" style="zoom:50%;" />
通过一个哈希函数，进行插入（有可能冲突），如果查找的时候，用哈希函数进行索引
冲突处理：<img src="/home/fangsong/文档/图片/2020-02-22 14-37-02屏幕截图.png" style="zoom:50%;" />
...
<img src="/home/fangsong/文档/图片/2020-02-22 16-04-18屏幕截图.png"  />
当中序遍历后他是个有序的数列，解决检索与排名

##### <font color = red>插入:</font>

<img src="/home/fangsong/文档/图片/2020-02-22 16-11-03屏幕截图.png"  />
10从头小于20往左走，小于17继续，大于3往右走：
<img src="/home/fangsong/文档/图片/2020-02-22 16-12-56屏幕截图.png"  />
...
![](/home/fangsong/文档/图片/2020-02-22 16-15-47屏幕截图.png)
１．删除叶子节点:直接删除
２．删除出度为１的节点:
![](/home/fangsong/文档/图片/2020-02-22 16-16-25屏幕截图.png)
提升３的唯一子树
３．删除度为２的结点：
![](/home/fangsong/文档/图片/2020-02-22 16-22-58屏幕截图.png)
...
![](/home/fangsong/文档/图片/2020-02-22 16-36-15屏幕截图.png)
...
![](/home/fangsong/文档/图片/2020-02-22 18-24-51屏幕截图.png)
1.联通判断：O(1)
2.合并操作：O(n)
![](/home/fangsong/文档/图片/2020-02-22 18-30-59屏幕截图.png)
...
##### QUICK-UNION算法
![](/home/fangsong/文档/图片/2020-02-22 18-39-50屏幕截图.png)
![](/home/fangsong/文档/图片/2020-02-22 19-08-10屏幕截图.png)![](/home/fangsong/文档/图片/2020-02-22 22-01-54屏幕截图.png)
...
![](/home/fangsong/文档/图片/2020-02-22 19-38-44屏幕截图.png)
![](/home/fangsong/文档/图片/2020-02-22 19-45-42屏幕截图.png)
![](/home/fangsong/文档/图片/2020-02-22 19-55-11屏幕截图.png)
说明节点个数小的适合作为子树进行合并

![](/home/fangsong/文档/图片/2020-02-22 19-57-43屏幕截图.png)
![](/home/fangsong/文档/图片/2020-02-22 22-02-50屏幕截图.png)
路径压缩：将０指向３
![](/home/fangsong/文档/图片/2020-02-22 20-05-45屏幕截图.png)
![](/home/fangsong/文档/图片/2020-02-22 20-09-15屏幕截图.png)
...
![](/home/fangsong/文档/图片/2020-02-22 20-10-09屏幕截图.png)
